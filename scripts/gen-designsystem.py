...
PAGES = [
    ...
    dict(slug="c", num="03", name="Bone", em="Protocol",
         mood="The contrarian: Valorant's signature off-white, flipped to light mode. Paper-bone surfaces, near-black ink, red and orange doing the shouting. Feels like a broadcast graphics package — nobody else in gaming dares to ship light.",
         display="Archivo Black", display_css="'Archivo Black',sans-serif", display_ls="0", font_q="Archivo+Black",
         tokens=dict(bg="#ECE8E1", surface="#F7F4EE", field="#FFFFFF", ink="#101820", muted="#6E6A60",
                     line="rgba(16,24,32,.16)", line_strong="rgba(16,24,32,.4)",
                     primary="#FF4655", on_primary="#FFF6F0", secondary="#0F6F5C", alert="#FF7A30"),
         card_icon="var(--secondary)",
         swatches=[("#ECE8E1","Bone","bg"),("#F7F4EE","Paper","surface"),("#101820","Night","ink"),
                   ("#FF4655","Riot Red","primary"),("#FF7A30","Ember","warm alert"),("#0F6F5C","Pine","secondary")]),
